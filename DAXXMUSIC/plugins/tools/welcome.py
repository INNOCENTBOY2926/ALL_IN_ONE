...
▰▰▰▰▰▰▰▰▰▰▰▰▰
{member.chat.title}
(☞ﾟヮﾟ)☞ THIS GROUP IS OPEN FOR ALL 24/7 ❤️😄😄☜(ﾟヮﾟ☜)
▰▰▰▰▰▰▰▰▰▰▰▰▰
**➻ 𝐍ᴀᴍᴇ »** {user.mention}
**➻ 𝐈ᴅ »** `{user.id}`
...
┃    🅞🅤🅡 🅖🅡🅞🅤🅟 🅡🅤🅛🅔🅢 
┃      
┃   ➳メ𝙳𝙾𝙽'𝚃 𝙳𝙼 𝙰𝙽𝚈𝙾𝙽𝙴 𝚆𝙸𝚃𝙷𝙾𝚄𝚃     ┃𝙿𝙴𝚁𝙼𝙸𝚂𝚂𝙸𝙾𝙽  
┃   ➳ メ𝙰𝙱𝚄𝚂𝙴 = 𝙱𝙰𝙽 🚫
┃   ➳ メ𝚄𝚂𝙸𝙽𝙶 15+ 𝚂𝚃𝚄𝙵𝙵𝚂 = 𝙱𝙰𝙽 🚫
┃   ➳ メ𝙿𝚁𝙾𝙼𝙾𝚃𝙸𝙾𝙽 𝙽𝙾𝚃 𝙰𝙻𝙻𝙾𝚆𝙴𝙳
┃   ➳ メJUST FUN WITH STRANGERS
┃   ➳ メMAKE NEW FRIENDS
┃   ➳ メLEARN SOMTHING NEW WITH US❤️✌️
┃   
┗━━━━━━━━━━━━━━━━━━━━━━━
𝙏𝙃𝘼𝙉𝙆 𝙔𝙊𝙐 𝙁𝙊𝙍 𝙅𝙊𝙄𝙉𝙄𝙉𝙂❣️
